...
## Sistema de Login Próprio e Telas por Perfil (Fase 28)
- [x] Atualizar schema de users com campos username e passwordHash
- [x] Criar procedures de autenticação (login, logout)
- [x] Criar usuários padrão (Moises ADMIN, Gabriel SUPERVISOR)
- [x] Fazer upload da logomarca para projeto
- [x] Criar 5 usuários de teste (Decoradora, Dono, Fornecedor, Assistente 1 e 2)
- [x] Criar schema de funcionários e observações
- [x] Criar procedures tRPC de agenda (funcionários e observações)
- [x] Criar tela de login profissional com identidade visual Festeja Kids
- [x] Criar tela Agenda do Supervisor (funcionários, pagamentos, observações)
- [x] Criar placeholders Tarefas e Metas
- [ ] Implementar proteção de rotas por role
- [ ] Implementar tela Dashboard do Mês do Supervisor
- [ ] Implementar tela Visitação do Supervisor
- [ ] Implementar tela Contratos do Supervisor
- [ ] Testar fluxo completo de login e navegação
- [ ] Validar permissões por perfil


## Seletor de Usuário e Telas do Supervisor (Fase 29)
- [x] Criar seletor de usuário simples na página inicial
- [x] Remover tela de login (desenvolver depois)
- [x] Criar layout do Supervisor com navegação lateral
- [x] Implementar tela Dashboard do Mês (métricas mensais)
- [x] Implementar tela Visitação do Supervisor
- [x] Implementar tela Contratos do Supervisor
- [x] Adicionar SupervisorLayout a todas as telas
