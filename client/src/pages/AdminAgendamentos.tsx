...
export default function AdminAgendamentos() {
    ...
    const handleStatusChange = (id: number, status: "realizada" | "cancelada" | "noshow") => {
        updateStatusMutation.mutate({ id, status });
    };

    const getStatusBadge = (status: string) => {
        switch (status) {
            case "agendada": return <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200">Agendada</Badge>;
            case "realizada": return <Badge variant="outline" className="bg-green-50 text-green-700 border-green-200">Realizada</Badge>;
            case "cancelada": return <Badge variant="outline" className="bg-red-50 text-red-700 border-red-200">Cancelada</Badge>;
            case "noshow": return <Badge variant="outline" className="bg-orange-50 text-orange-700 border-orange-200">Não Compareceu</Badge>;
        ...
        <div className="min-h-screen bg-slate-50 p-8">
            <div className="max-w-6xl mx-auto">
                <div className="flex justify-between items-center mb-8">
                    <div>
                        <h1 className="text-3xl font-bold text-slate-900">Gestão de Visitas</h1>
                        <p className="text-slate-500">Acompanhe e gerencie as visitas agendadas ao salão.</p>
                    </div>
                    <Link href="/dashboard">
                                    ...
                                    <div className="p-6 flex-1">
                                        <div className="flex flex-wrap items-center gap-3 mb-3">
                                            ...
                                            <span className="text-sm text-slate-400 flex items-center gap-1">
                                                ...
                                                Agendado em {format(new Date(visita.createdAt), "dd/MM/yyyy", { locale: ptBR })}
                                            </span>
                                        </div>
                                        ...
                                        <div className="grid md:grid-cols-2 gap-6">
                                            ...
                                            <div>
                                                <div className="flex items-center gap-2 text-lg font-semibold text-pink-600 mb-1">
                                                    ...
                                                    {format(new Date(visita.dataAgendamento), "dd 'de' MMMM 'às' HH:mm", { locale: ptBR })}
                                                </div>
                                                {visita.tipoEvento && (
                                        ...
                                        {visita.status === "agendada" && (
                                            <>
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => handleStatusChange(visita.id, "noshow")}
                                                >
                                                ...
                                                <Button
                                                    ...
                                                    onClick={() => handleStatusChange(visita.id, "cancelada")}
                                                >
