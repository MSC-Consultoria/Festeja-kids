...
const leadSchema = z.object({
    ...
    valorPotencial: z.string().transform((val) => Number(val) * 100).optional(), // Input em reais, salva em centavos
});
        ...
        <div className="h-screen flex flex-col bg-slate-50">
            <header className="bg-white border-b border-slate-200 px-6 py-4 flex justify-between items-center">
                <div>
                    ...
                    <p className="text-sm text-slate-500">Gerencie seus leads e oportunidades</p>
                </div>
                                            ...
                                            <FormItem>
                                                ...
                                                <Select onValueChange={field.onChange} defaultValue={field.value}>
                                                    ...
                                                    <SelectContent>
                                                        ...
                                                        <SelectItem value="anuncio_insta">Anúncio Instagram</SelectItem>
                                                        <SelectItem value="anuncio_google">Anúncio Google</SelectItem>
